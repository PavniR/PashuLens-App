    ...
    NavHost(
        ...
        composable("analysis_results") {
            AnalysisResultScreen(
                onBackClicked = { navController.popBackStack() },
                onAcceptClicked = {
                    // Example: Navigate to Home after accepting
                    navController.navigate(Screen.Home.route) {
                        popUpTo(Screen.Home.route) { inclusive = true }
                    }
                },
                onSuggestCorrectionsClicked = {
                    // Example: Navigate to SuggestCorrections screen
                    navController.navigate("suggest_corrections")
                }
            )
        }
        ...
        composable("suggest_corrections") {
            SuggestCorrectionsScreen(
                onBackClicked = { navController.popBackStack() },
                onSubmitClicked = {
                    // after submitting, show success screen
                    navController.navigate("success/analysis")
                }
            )
        }
